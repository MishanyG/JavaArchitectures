...
public class Product_Poltergeist {
    private int idProduct;
    private String name;
    private Long purchasePrice;
    private Long price;

    public Product_Poltergeist(int idProduct, String name, Long purchasePrice, Long price) {
...
class Product_Controller {
    private Product_Poltergeist model;
    private ProductView view;
    private ProductDB productDB;

    public Product_Controller(int idProduct, Product_Poltergeist model, ProductView view, ProductDB productDB) {
        this.view = view;
    ...
    public Product_Poltergeist findById(int idProduct) {
...
class MainMVC {
    public static void main(String[] args) throws SQLException {
        ...
        Product_Poltergeist model = new Product_Poltergeist();
        ProductView view = new ProductView();
        Product_Controller controller = new Product_Controller(2, model, view, productDB);
...
class ProductDB {
    ...
    public Product_Poltergeist findById(int idProduct) {
        try {
            ...
            while(rs.next()) {
                Product_Poltergeist product = new Product_Poltergeist();
    ...
    public void insert(Product_Poltergeist product) {
        try {
    ...
    public void update(Product_Poltergeist product) {
        try {
